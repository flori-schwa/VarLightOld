...
@ForMinecraft(version = "Paper 1.14.4")
public class NmsAdapter implements INmsAdapter, Listener {
    ...
    public NmsAdapter(VarLightPlugin plugin) {
        ...
        if (!plugin.isPaper()) {
            throw new VarLightInitializationException("You are using the Paper implementation of VarLight on a normal Spigot Server!");
        }
