...
public class NmsAdapter implements INmsAdapter {
    ...
    public boolean isCorrectTool(Material block, Material tool) {
        net.minecraft.server.v1_9_R2.Block nmsBlock = CraftMagicNumbers.getBlock(block);
        Item item = CraftMagicNumbers.getItem(tool);

        net.minecraft.server.v1_9_R2.ItemStack stack = new net.minecraft.server.v1_9_R2.ItemStack(item);
    ...
    public int getGlowingValue(org.bukkit.inventory.ItemStack glowingStack) {
        net.minecraft.server.v1_9_R2.ItemStack nmsStack = CraftItemStack.asNMSCopy(glowingStack);
    ...
    public @NotNull File getRegionRoot(World world) {
        ...
        try {
            ChunkProviderServer chunkProvider = ReflectionHelper.Safe.get(nmsWorld, "chunkProvider");
