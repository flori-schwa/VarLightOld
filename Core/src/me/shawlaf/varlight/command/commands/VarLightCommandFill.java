...
import static me.shawlaf.varlight.command.commands.arguments.CollectionArgumentType.collection;
...
//    }
    ...
    private int fill(Player source, Location pos1, Location pos2, int lightLevel, Predicate<Material> filter) {
        ...
        IntPosition a = new IntPosition(pos1);
        IntPosition b = new IntPosition(pos2);
