...
public class NmsAdapter implements INmsAdapter {
    ...
    public Material keyToType(String namespacedKey, MaterialType type) {
        ...
        switch (type) {
            ...
            case BLOCK: {
                return CraftMagicNumbers.getMaterial(net.minecraft.server.v1_10_R1.Block.REGISTRY.get(key));
            }
        }
    ...
    public boolean isCorrectTool(Material block, Material tool) {
        net.minecraft.server.v1_10_R1.Block nmsBlock = CraftMagicNumbers.getBlock(block);
        Item item = CraftMagicNumbers.getItem(tool);

        net.minecraft.server.v1_10_R1.ItemStack stack = new net.minecraft.server.v1_10_R1.ItemStack(item);
    ...
    public String materialToKey(Material material) {
        return material.isBlock() ?
                net.minecraft.server.v1_10_R1.Block.REGISTRY.b(CraftMagicNumbers.getBlock(material)).toString() :
    ...
    public int getGlowingValue(org.bukkit.inventory.ItemStack glowingStack) {
        net.minecraft.server.v1_10_R1.ItemStack nmsStack = CraftItemStack.asNMSCopy(glowingStack);
